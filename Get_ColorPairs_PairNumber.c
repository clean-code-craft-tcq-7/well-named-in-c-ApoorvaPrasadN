...
void Mapping_StringToColorPair(const ColorPair* colorPair,int pairnumber) {
    sprintf(MajorColorNames_Array[colorPair->majorColor],MinorColorNames_Array[colorPair->minorColor], "%d",pairnumber);
}
